(function (factory) {
 ...
 $.extend(ScrollTo.prototype,{
  ...
  prepare:function(){
   ...
   self.trigger('active',[{active:self.props.active}]);
   ...
   mgr.get('lib.utils.winResizeScroll')({
    events:'scroll'+self.options.namespace+' resize'+self.options.namespace,

...
(function (factory) {
 ...
 $.extend(Box.prototype,{
  ...
  setControls:function(){
   ...
   self.props.pop.center.on('touchstart',function(e){
  ...
  touchStart:function(e){
   ...
   mgr.helpers.doc.on('touchmove',function(e){
    var delta=self.props.coords['pageX']-e.originalEvent.touches[0]['pageX'];

    if(self.props.touch&&Math.abs(delta)>self.options.touchThreshold&&Math.abs(delta)>2*Math.abs(self.props.coords['pageY']-e.originalEvent.touches[0]['pageY']))
    {
     self.props.coords['pageX']=e.originalEvent.touches[0]['pageX'];
     self.props.coords['pageY']=e.originalEvent.touches[0]['pageY'];
    ...
    mgr.helpers.doc.off('touchend').off('touchmove');
   });
  },
  setResize:function(){
   var self=this;
  ...
  open:function(opts){
   ...
   self.props.index=self.props.data||self.options.delegateCallers?0:self.props.callers.index(self.props.caller);
   self.insertData();

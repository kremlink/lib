   ...
   if(self.options.touch.enabled)
   {
    self.props.touch=new (mgr.get('lib.utils.drag'))({
     ...
     dragCallback:function(e){
      ...
      if(!self.props.hide)
      {
       delta=e[self.props.coord]-self.props.value-self.props.start;
